...
export class PrivateLayoutComponent implements OnInit {
    ...
    this.router.events.subscribe((event: Event) => {
      ...
      if (event instanceof NavigationEnd) {
        ...
        if (this.router.url === "/plans") {
          this.renderer.addClass(document.body, "app-plan");
        } else {
          this.renderer.removeClass(document.body, "app-plan");
        }
        if (this.router.url === "/offre") {
          this.renderer.addClass(document.body, "app-offer");
        } else {
          this.renderer.removeClass(document.body, "app-offer");
        }
    ...
    this._themeSettingsService.config
      ...
      .subscribe((config) => {
        ...
        if (localStorage.getItem("currentLayoutStyle")) {
          this._themeSettingsConfig.layout.style =
            localStorage.getItem("currentLayoutStyle");
        }
      });
  ...
  handleBody(isMobile: boolean) {
    ...
    if (
      this._themeSettingsConfig.layout.style === "vertical" &&
      ...
      this._themeSettingsConfig.layout.style === "horizontal" &&
    ...
    if (
      ...
      currentBodyClassList.push("chat-application");
      currentBodyClassList = currentBodyClassList.filter(
        (item) => item !== "fixed-bottom"
      );
    ...
    if (this.router.url === "/plans") {
      currentBodyClassList.push("app-plan");
    }
    if (this.router.url === "/offre") {
      currentBodyClassList.push("app-offer");
    }
    if (this.router.url === "/abonnement") {
      currentBodyClassList.push("app-abonnement");
    }
    if (this.router.url === "/todos") {
