...
export const areaChartLabels: Array<any> = [
  "January",
  "February",
  "March",
  "April",
...
export const scatterChartLabels: Array<any> = [
  "January",
  "February",
  "March",
  "April",
...
export const doughnutChartColors: any[] = [
  { backgroundColor: ["#00a5a8", "#28d094", "#ff4558", "#ff7d4d", "#626e82"] },
];
...
///////////////////// start polar-chart///////////
// PolarArea
export const polarAreaChartLabels: string[] = [
  "January",
  "February",
  "March",
  "April",
...
export const ploarChartColors: any[] = [
  { backgroundColor: ["#00a5a8", "#28d094", "#ff4558", "#ff7d4d", "#626e82"] },
];
